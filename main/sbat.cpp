...
void gcta::sbat_old(string sAssoc_file, string snpset_file, double sbat_ld_cutoff, bool sbat_write_snpset)
{
    int i = 0, j = 0;
    int snp_count;
...
void gcta::sbat_seg_old(string sAssoc_file, int seg_size, double sbat_ld_cutoff, bool sbat_write_snpset)
{
    int i = 0, j = 0;
    int snp_count;
