...
public:
    ...
    // mlma
    void mlma(string grm_file, bool m_grm_flag, string phen_file, string qcovar_file, string covar_file, int mphen, int MaxIter, vector<double> reml_priors, vector<double> reml_priors_var, bool no_constrain, bool within_family, bool inbred, bool no_adj_covar);
    ...
    void sbat_gene(string sAssoc_file, string gAnno_file, int wind, bool sbat_ld_cutoff, bool sbat_write_snpset);
    void sbat(string sAssoc_file, string snpset_file, bool sbat_ld_cutoff, bool sbat_write_snpset);
    void sbat_seg(string sAssoc_file, int seg_size, bool sbat_ld_cutoff, bool sbat_write_snpset);
...
private:
    ...
    */
    ...
    void sbat_calcu_lambda(vector<int> &snp_indx, VectorXd &eigenval, int &snp_count, bool sbat_ld_cutoff, vector<int> &sub_indx);
